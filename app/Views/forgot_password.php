...
<head>
    ...
    <title><?= $title ?? 'Lupa Kata Sandi - NusaShare' ?></title>
...
<body class="h-screen w-full flex items-center justify-center bg-slate-50 px-6">
    ...
    <div class="w-full max-w-md">
        <!-- Back Link -->
        <a href="<?= base_url('login') ?>" class="inline-flex items-center gap-2 text-sm text-slate-500 hover:text-[#4F46E5] mb-8 transition-colors group">
        ...
        <div class="bg-white p-8 rounded-3xl shadow-xl shadow-slate-200/60 border border-slate-100">
            <!-- Header -->
            <div class="mb-8">
                <div class="w-12 h-12 bg-indigo-50 rounded-2xl flex items-center justify-center text-[#4F46E5] mb-4">
                ...
                <p class="text-slate-500 text-sm leading-relaxed">Jangan khawatir, kami akan mengirimkan instruksi pemulihan ke email Anda.</p>
            </div>
        ...
        <p class="mt-8 text-center text-sm text-slate-500">
            Butuh bantuan lain? <a href="#" class="text-[#4F46E5] font-semibold hover:underline">Hubungi kami</a>
        </p>
    </div>
