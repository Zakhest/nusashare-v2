...
<body class="h-screen w-full overflow-hidden flex">
    ...
    <div class="w-full lg:w-1/2 h-full flex flex-col justify-center items-center bg-white px-6 sm:px-12 md:px-20 relative overflow-y-auto">
        ...
        <a href="<?= base_url('explore') ?>" class="absolute top-8 right-8 text-sm text-slate-500 hover:text-[#4F46E5] flex items-center gap-1 transition-colors group">
        ...
        <div class="w-full max-w-md py-12">
            ...
            <div class="mb-10 text-center lg:text-left">
                ...
                <p class="text-slate-500">Mulai langkah pertamamu sebagai bagian dari NusaShare.</p>
            </div>
            ...
            <form action="<?= base_url('register') ?>" method="POST" class="space-y-4">
                <div>
                    ...
                    <input type="text" id="username" name="username" class="input-field w-full px-4 py-3 rounded-xl border border-slate-300 text-slate-900 placeholder-slate-400 focus:outline-none" placeholder="budisantoso" value="<?= old('username') ?>" required>
                </div>

                <div>
                    <label for="email" class="block text-sm font-medium text-slate-700 mb-1.5">Email</label>
                    <input type="email" id="email" name="email" class="input-field w-full px-4 py-3 rounded-xl border border-slate-300 text-slate-900 placeholder-slate-400 focus:outline-none" placeholder="budi@example.com" value="<?= old('email') ?>" required>
                </div>
                ...
                <div class="flex items-start gap-3 mt-2">
                    <input type="checkbox" id="terms" class="mt-1 h-4 w-4 rounded border-slate-300 text-[#4F46E5] focus:ring-[#4F46E5]" required>
                    <label for="terms" class="text-xs text-slate-500 leading-normal">
                        Saya menyetujui <a href="<?= base_url('terms') ?>" class="text-[#4F46E5] font-semibold hover:underline">Syarat & Ketentuan</a> serta <a href="<?= base_url('privacy') ?>" class="text-[#4F46E5] font-semibold hover:underline">Kebijakan Privasi</a> NusaShare.
                    </label>
                </div>

                <!-- Submit -->
                <button type="submit" class="btn-gradient w-full py-3.5 rounded-xl text-white font-bold text-lg shadow-lg shadow-indigo-500/30 mt-4">
                    Daftar Sekarang
                </button>
            </form>
            ...
            <div class="relative my-8">
                ...
                <div class="relative flex justify-center text-sm">
                    <span class="px-2 bg-white text-slate-400">atau daftar dengan</span>
                </div>
            </div>

            <!-- Social Buttons -->
            <div class="flex gap-4">
                <button class="flex-1 flex items-center justify-center gap-2 py-2.5 border border-slate-200 rounded-xl hover:bg-slate-50 hover:border-slate-300 transition-all">
                    <img src="https://www.svgrepo.com/show/475656/google-color.svg" class="w-5 h-5" alt="Google">
                    <span class="text-sm font-medium text-slate-700">Google</span>
                </button>
                <button class="flex-1 flex items-center justify-center gap-2 py-2.5 border border-slate-200 rounded-xl hover:bg-slate-50 hover:border-slate-300 transition-all">
                    <img src="https://www.svgrepo.com/show/442938/apple-logo.svg" class="w-5 h-5" alt="Apple">
