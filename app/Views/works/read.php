...
<body class="min-h-screen">
    ...
    <main class="reader-container px-6 py-12 md:py-20 lg:py-24">
        ...
        <div class="mt-20 pt-12 border-t border-slate-200">
            <div class="flex flex-col sm:flex-row justify-between items-center gap-6">
                ...
                <a href="<?= base_url('works/' . $work['id']) ?>" class="p-4 rounded-full bg-slate-100 text-slate-500 hover:bg-slate-200 transition-all" title="Daftar Isi">
    ...
    (function () {
        ...
        const CHAPTER_ID   = <?= (int)$chapter['id'] ?>;
        const THRESHOLD_MS = 4 * 60 * 1000; // 4 menit
        const BASE_URL     = '<?= rtrim(base_url(), '/') ?>';
        const LS_KEY       = 'nusa_view_' + WORK_ID + '_ch' + CHAPTER_ID;
        ...
        // Batalkan jika user pindah halaman sebelum 4 menit
